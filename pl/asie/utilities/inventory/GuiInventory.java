package pl.asie.utilities.inventory;
...
public class GuiInventory extends GuiContainer implements IGUITileEntity
{
	...
	public GuiInventory(InventoryPlayer inventoryPlayer, TileEntityInventory tileEntity, ContainerInventory inventory, int xs, int ys, String modName, String textureName) {
		super(inventory);
		this.inventorySlots = inventory;
		this.tileEntity = tileEntity;
		this.xSize = xs;
		this.ySize = ys;
		this.texture  = new ResourceLocation(modName, "textures/gui/" + textureName + ".png");
	}
